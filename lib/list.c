...
// 在 anchor 结点前插入结点 node，anchor表示目标节点，是待处理节点
...
void list_push(list_t *list, list_node_t *node)
{
    ...
    list_insert_after(&list->head, node);// 插入到头节点之后
}
...
// 判断链表是否为空，头节点的下个节点是尾节点，则代表这个双向链表是空的
